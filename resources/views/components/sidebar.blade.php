    ...
    <section class="sidebar">
        <div class="user-panel">
            <div class="pull-left image">
                <img src="{{ asset('dist/img/user2-160x160.jpg') }}" class="img-square" style="border-radius: 3px;" alt="User Image">
            </div>
        ...
        <form action="{{ route('dashboard') }}" method="GET" class="sidebar-form">
            <div class="input-group">
                <input type="text" class="form-control text-uppercase pull-right" style="width: 180px;font-size:11.4px;" name="keyword" id="keyword" value="{{ request('keyword') }}" placeholder="Search" disabled>
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview {{ request()->is('transaksi/tabungan', 'transaksi/sma', 'pembukaan/deposito', 'pembukaan/tabungan') ? 'active menu-open' : '' }}">
                <a href="#">
                    <i class="fa fa-tv"></i>
            ...
            <li class="{{ request()->is('cetak/tabungan', 'cetak/tabungan/search') ? 'active' : '' }}">
                <a href="{{ route('tabungan.cetak.index') }}">
