@extends('layouts.app')
@section('title', 'Update QQ Tabungan')
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="box box-success">
                        ...
                        <form role="form" action="{{ route('tabungan.update') }}" method="POST">
                            @method('PUT')
                            @csrf
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nocif" value="{{ $tabungan->nocif }}"
                                        readonly>
                                </div>
